...
public class ApiResponse<T> {
    ...
    private final static String FAILED_MESSAGE = "서버에서 오류가 발생했습니다.";
    private final static String INVALID_ACCESS_TOKEN = "유효하지 않은 토큰입니다.";
    private final static String INVALID_REFRESH_TOKEN = "유효하지 않은 리프레시 토큰입니다.";
